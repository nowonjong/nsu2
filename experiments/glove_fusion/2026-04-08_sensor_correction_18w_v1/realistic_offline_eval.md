...
- Model: `C:\SignProject\experiments\glove_fusion\2026-04-08_sensor_correction_18w_v1`
- Input format: `sensor_correction_flex_lstm`
- Test Accuracy: `0.9889`
- Test Macro F1: `0.9888`
- Hard-case Accuracy: `0.9630`
- Hard-case Macro F1: `0.8182`
- Low-margin rate < 0.10: `0.0111`
- Low-margin rate < 0.20: `0.0111`
- Worst-group Accuracy: `0.9000`

## Similar Groups
- 방향 차이형 (`direction_difference`): acc=1.0000, macro_f1=1.0000, intra_conf=0.0000, n=15
- 손목각도 차이형 (`wrist_angle_difference`): acc=0.9000, macro_f1=0.8990, intra_conf=0.1000, n=10
- 굽힘/경로 차이형 (`bend_path_difference`): acc=1.0000, macro_f1=1.0000, intra_conf=0.0000, n=15
